...
const AboutPage = () => (
  <main className="max-w-2xl mx-auto py-16 px-4 text-center">
    ...
    <p className="text-lg text-gray-700 mb-4">
      نحن فريق متخصص في تطوير المواقع والتطبيقات الحديثة باستخدام أحدث التقنيات
      مثل Next.js و React و TypeScript.
    </p>
    <p className="text-lg text-gray-700 mb-4">
      هدفنا هو تقديم حلول رقمية مبتكرة تساعد عملاءنا على النجاح في عالم
      الإنترنت.
    </p>
    <p className="text-lg text-gray-700">
      نؤمن بالإبداع، الجودة، والالتزام في جميع مشاريعنا.
    </p>
  </main>
);
